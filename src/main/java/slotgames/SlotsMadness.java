...
public class SlotsMadness {
	...
	private SlotSymbol[] symbols = {
			new SlotSymbol(2, "bonus",false,true,false),
			
			new SlotSymbol(0, "scatter",false,false,true),
			
			new SlotSymbol(2, "wild",true,false,false),
			
			new SlotSymbol(0, "kulta"),
			
			new SlotSymbol(1, "hopea"),
			
			new SlotSymbol(2, "pronssi"),
			
			new SlotSymbol(3, "hakku"),
			
			new SlotSymbol(4, "lintu"),
			
			new SlotSymbol(5, "marjat"),
			
			new SlotSymbol(5, "muki")
	};
