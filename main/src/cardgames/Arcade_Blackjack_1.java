...
public class Arcade_Blackjack_1 implements ICoinGame {
	...
	private AudioClip shuffleSound = new AudioClip("file:./main/src/res/sounds/sekoitus1.wav");
	private AudioClip dealSound = new AudioClip("file:./main/src/res/sounds/jako1.wav");
